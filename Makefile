...
#
TEST = invalid-init invalid-read-terminal invalid-stats more-stats stats test-echo test1 test2 test3 test4 use-before-init write-terminal-too-long write-terminal-too-short
ALL = $(MONTTY) $(TEST)
